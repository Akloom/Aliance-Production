  ...
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <div class="benefits__item">
        ...
        <p class="benefits__item-desc">Непрерывная работа c 2017 года</p>
      </div>
    </div>
    <div class="swiper-slide">
      <div class="benefits__item">
        ...
        <p class="benefits__item-desc">Вся продукция сертифицирована</p>
      </div>
    </div>
    <div class="swiper-slide">
      <div class="benefits__item">
        ...
        <p class="benefits__item-desc">Контроль качества на всех этапах</p>
      </div>
    </div>
    <div class="swiper-slide">
      <div class="benefits__item">
        ...
        <p class="benefits__item-desc">Возможны поставки по всей России</p>
      </div>
    </div>
    <div class="swiper-slide">
      <div class="benefits__item">
        ...
        <p class="benefits__item-desc">Оперативное производство</p>
      </div>
    </div>
  </div>
